...
const pengajar = [
  ...
  { name: 'Dr. Faizatul Anshoriah, S.Sos., M.Si.', image: '/images/profil/faiz.png' },
...
useSeoMeta({
  ...
  description: 'Selayang pandang, visi, misi, dan struktur pengurus Omah Ngaji Al-Anshori — asrama mahasiswa berbasis pesantren di Surakarta.',
  ogTitle: 'Profil — Omah Ngaji Al-Anshori',
  ogDescription: 'Selayang pandang, visi, misi, dan struktur pengurus Omah Ngaji Al-Anshori.',
        ...
        <div class="mb-12">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-10">
            <figure
              ...
              class="text-center"
            >
              <div class="aspect-square rounded-full overflow-hidden bg-neutral-200 mx-auto max-w-[200px]">
                <NuxtImg
                  :src="person.image"
                  :alt="person.name"
                  loading="lazy"
              ...
              <figcaption class="mt-5 font-bold text-sm md:text-base">
                {{ person.name }}
              </figcaption>
            </figure>
          </div>
        ...
        <div>
          ...
          <div class="grid grid-cols-2 sm:grid-cols-3 gap-x-6 gap-y-10">
            <figure
              ...
              class="text-center"
            >
              <div class="aspect-square rounded-full overflow-hidden bg-lime-200 mx-auto max-w-[220px]">
                <NuxtImg
                  :src="person.image"
                  :alt="person.name"
                  loading="lazy"
